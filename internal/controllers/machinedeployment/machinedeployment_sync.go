...
func (r *Reconciler) sync(ctx context.Context, d *clusterv1.MachineDeployment, msList []*clusterv1.MachineSet) error {
	...
	return updateStatus(allMSs, newMS, d)
}
...
// updateStatus calculates the latest status for the provided MaachineDeployment by looking into the provided MachineSets.
func updateStatus(allMSs []*clusterv1.MachineSet, newMS *clusterv1.MachineSet, machineDeployment *clusterv1.MachineDeployment) error {
